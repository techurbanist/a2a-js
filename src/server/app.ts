    ...
    app.post('/', (req: Request, res: Response) => {
      ...
      try {
        switch (jsonRpcRequest.method) {
          case 'message/send':
            self.requestHandler.onMessageSend(jsonRpcRequest as any)
          ...
          case 'message/sendStream':
            ...
            (async () => {
              try {
                ...
                const sseGenerator = self.requestHandler.onMessageSendStream(jsonRpcRequest as any);
          ...
          case 'tasks/get':
            self.requestHandler.onGetTask(jsonRpcRequest as any)
              .then(taskResponse => {
          ...
          case 'tasks/cancel':
            self.requestHandler.onCancelTask(jsonRpcRequest as any)
              .then(cancelResponse => {
          ...
          case 'tasks/pushNotificationConfig/set':
            self.requestHandler.onSetTaskPushNotification(jsonRpcRequest as any)
          ...
          case 'tasks/pushNotificationConfig/get':
            self.requestHandler.onGetTaskPushNotification(jsonRpcRequest as any)
          ...
          case 'tasks/resubscribe':
            ...
            (async () => {
              try {
                const resubscribeGenerator = self.requestHandler.onResubscribeToTask(jsonRpcRequest as any);
